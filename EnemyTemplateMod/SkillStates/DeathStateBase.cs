...
{
    public class DeathStateBase : GenericCharacterDeath
    {
        public uint moneyEarned { get; set; }

        public ulong experienceEarned { get; set; }
        ...
        public override void OnEnter()
        {
            ...
            if (active)
            {
                ...
                Destroy(gameObject);
                TeamManager.instance.GiveTeamMoney(TeamIndex.Player, moneyEarned * (uint)((base.characterBody.level) * 1.2));
                TeamManager.instance.GiveTeamExperience(TeamIndex.Player, experienceEarned * (ulong)((base.characterBody.level) * 1.2));
            }
        }
