...
namespace HenryMod.Modules
{
    internal static class Tokens
    {
        ...
        {
            #region Henry
            string prefix = EnemyPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_";
            ...
            LanguageAPI.Add(prefix + "SKITTER_NAME", "SkitterRail");
            LanguageAPI.Add(prefix + "SKITTER_DESCRIPTION", Helpers.agilePrefix + $"Fire a handgun for <style=cIsDamage>{100f * StaticValues.gunDamageCoefficient}% damage</style>.");
            #endregion
